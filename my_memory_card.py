...
questions_list.append(Question('Корень из 4', '2','4','8','16'))
questions_list.append(Question('Какая команда выйграла The Internetional 2023', 'Team Spirit','Gaimin Gladiators','9Pandas','PSG.LGD'))
questions_list.append(Question('Формула количества теплоты','cm(t2-t1)','лm(t2-t1)','qm(t2-t1)','hm(t2-t1)'))
questions_list.append(Question('''Кто написал 'Войну и мир' ''','Толстой','Достоевский','Пушкин','Лермонтов'))
app = QApplication([])
